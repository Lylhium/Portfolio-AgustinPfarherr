                 ...
                 <div className='c-info'>
                   ...
                   <div className='c-info-item'>
                      <img src= {Linkedin} className='c-icon' alt='img'/>
                       <a href={'https://www.linkedin.com/in/agust%C3%ADn-pfarherr-623188211/'} style={{color:'white'}} target="_blank">Linkedin</a>
                   </div>
                   <div className='c-info-item'>
                      <img src= {Github} className='c-icon' alt='img'/>
                       <a href={'https://github.com/Lylhium?tab=repositories'} style={{color:'white'}} target="_blank">GitHub</a>
                   </div>
                   <div className='c-info-item'>
                      <img src= {Address} className='c-icon' alt='img' />
                      <a href={'https://goo.gl/maps/2Hs3EV9E2NQaFARk6'} style={{color:'white'}} target="_blank">La Paternal, Capital Federal , Argentina</a>
                    </div>      
                 </div>
             </div>
             <div className='c-right'>
                 <p className='c-desc'>
                     <h2 className='c-contact'>Necesitas ponerte en contacto conmigo?</h2>
                 ...
                 <form ref={formRef} onSubmit={handleSubmit}>
                     ...
                     <button className='btn-send' onClick={() => mostrarAlerta()} >Enviar</button>
                     {done && <h2 className='c-contact'>Correo Enviado.</h2> }
